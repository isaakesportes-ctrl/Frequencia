    ...
    <div className="space-y-8 md:space-y-12 max-w-[1400px] mx-auto pb-10">
      ...
      <motion.div variants={container} initial="hidden" animate="show" className="space-y-10 md:space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {[
            { label: "Aulas", value: currentStats.totalAulas, icon: Calendar, color: "blue", bg: "bg-[#0071e3]" },
            { label: "Equipe", value: currentStats.totalProfessores, icon: Users, color: "red", bg: "bg-[#ff3b30]" },
                ...
                <CardContent className="p-8">
                  <div className="space-y-6">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-4xl font-black text-slate-900 dark:text-white truncate">
                        {stat.value}
                      </p>
                    </div>
                  </div>
